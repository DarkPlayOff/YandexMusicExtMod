> [!WARNING]
> Яндекс с версии 5.29.0 внедрил проверку целостности asar поэтому временно патчер будет скачивать версию 5.28.0 для
> работы модификации
...
4. Нажмите кнопку **«Установить мод»**.
5. Приложение появится в папке с программами
6. После запуска приложение автоматически откроет страницу авторизации.
